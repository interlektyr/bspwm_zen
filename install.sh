...
sudo pacman -Syu --needed bottom nsxiv yazi ffmpeg 7zip jq poppler fd ripgrep fzf zoxide resvg imagemagick xorg-server xorg-xinit hunspell trash-cli kitty ouch thunar xarchiver thunar-archive-plugin w3m gum ranger ntfs-3g gvfs firefox dex xorg-xsetroot xsel wireless_tools git xdo bspwm sxhkd hsetroot xsettingsd picom dunst xed udisks2 udiskie pacman-contrib xorg-xrandr pamixer transmission-cli nvim neovide lsof
...
paru -S selectdefaultapplication-git dawn-bin arch-update hunspell-sv launch-cmd dragon-drop onlyoffice-bin conky-lua-nv marktext-bin autojump moonbit tdrop-git rxvt-unicode-truecolor-wide-glyphs lemonbar-xft-git tomb tufw-bin bluetuith tremc mullvad-vpn-bin zen-browser-bin librewolf-bin aurutils
